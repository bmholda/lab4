...
public class TwoDimArrayPractice extends JFrame
{
   ...
   public void printArray( )
   {
    ...
    // Write your code here:
	   ...
	   for(int l = 0; l < intArray.length; l++) {
		   for(int m = 0; m < intArray[l].length; m++) {
			   System.out.print(" " + intArray[l][m]);
			   animate(l, m);
		   }
		   System.out.println();
	   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   System.out.println("The minimum of the value is " + min );
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   System.out.println("The count frequency is " + value + " in the 2d array");
	   int total = 0;
	   for(int i = 0; i < intArray.length; i++) {
		   for(int j = 0; j < intArray[i].length; j++) {
		   ...
		   System.out.println("The count for this value is: " + total);
	   }
     return total; // replace this line with your return statement
   }
